"""Run the fixed-seed DIN-lite history experiment."""
...
def main() -> int:
    ...
    parser.add_argument("--plan", default="configs/part4_din_nodes.json")
    parser.add_argument("--output", default="results/part4_din")
